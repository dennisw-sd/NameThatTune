...
function updateScoreboard(gameState) {
	// Update team names
	document.getElementById('team1Name').textContent = gameState.team1.name.toUpperCase();
	document.getElementById('team2Name').textContent = gameState.team2.name.toUpperCase();
